...
class PrincipalWindow:
    def __init__(self, root: tb.Window):
        ...
        self.entry_dh_params_style.configure(
            "dh_params_config.TEntry", foreground="red", fieldbackground="gray"
        )
        self.entry_dh_params_style.configure(
            "default.TEntry", foreground="black", fieldbackground="white"
        )

        # ________________________________________________________________________

        # Reference for the handler of the frames.
        self.frames_handler = FrameHandler(self.serial_conn)
        ...
        self.serial_menu_frame = SerialConfigurationFrame(
            root,
            self.frames_handler,
            self.serial_conn,
        )
        self.robotic_configuration_frame = RoboticConfigurationFrame(
            root,
            self.frames_handler,
            self.robotic_properties,
        )
        self.robotic_params_frame = RoboticParamsFrame(
            root,
            self.frames_handler,
            self.robotic_properties,
        )
        self.direct_kinematics_frame = DirectKinematicsFrame(
            root,
            self.frames_handler,
            self.robotic_properties,
        ...
        self.inverse_kinematics_frame = InverseKinematicsFrame(
            root,
            self.frames_handler,
            self.robotic_properties,
        )
