...
servo1 = servo(a, "d9", "minpulseduration", 0.75e-3, "maxpulseduration", 2.275e-3);
writePosition(servo1, 0);

servo2 = servo(a, "d10", "minpulseduration", 0.95e-3, "maxpulseduration", 1.7252e-3);
% servo2 = servo(a, "d10", "minpulseduration", 0.6e-3, "maxpulseduration", 2.4e-3);
writePosition(servo2, 1);

servo3 = servo(a, "d11", "minpulseduration", 1.01e-3, "maxpulseduration", 1.78e-3);
% servo3 = servo(a, "d11", "minpulseduration", 0.6e-3, "maxpulseduration", 2.4e-3);
writePosition(servo3, 1);
